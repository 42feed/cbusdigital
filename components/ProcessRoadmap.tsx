...
const steps = [
  ...
  {
    number: "05",
    title: "50% deposit to move forward",
    description: "If you love what you see, you put 50% down. That's your signal to us that you're in — and it unlocks the full revision process.",
    duration: "Instant",
    icon: "💳",
    phase: "Refine",
  },
  {
    ...
    description: "Wrong font. Wrong color. Wrong headline. Doesn't matter — we fix it. This is also where you can send over any logos, photos, or additional content you want on the site. All of it gets incorporated. As many rounds as it takes until you'd proudly send that URL to your best customer.",
    duration: "1–3 rounds",
    icon: "🔁",
    phase: "Refine",
  },
